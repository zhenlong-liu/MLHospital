...
def get_non_image_parameter_set(method, loss_type = "ce", dataset = "cifar100", model ="wideresnet"):
    ...
    dropout_param = {
        ...
        "temp": [1],
        #"tau": [3],
        "tau": [0.6,0.65,0.75,0.8],
        # [0.01, 0.02,0.05 ,0.1, 0.3, 0.5, 0.7, 0.9],
        "gamma": [1]
    } 
    ...
    dpsgd_param= {  
        "alpha": [1e-4,5e-4,1e-3,5e-3,1e-2,0.05, 0.1, 0.5, 1],#[1e-4,1e-3,1e-2,0.1, 0.5, 1],
        "temp": [4],#[0.1,0.2,0.5,1,2,4,8,16],#[0.5,1,2,4],
        #"tau": [3],
        "tau": [1],
        "gamma": [1]
    }
    ...
    concave_exp_one_param = {
        "alpha": [0.25,0.35,0.45,0.55,0.65,0.75,0.85,0.95],
