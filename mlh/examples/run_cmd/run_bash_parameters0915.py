...
if __name__ == "__main__":
    ...
    'loss_type': 'concave_loss', # concave_log  concave_exp
    'learning_rate': 0.1,
    'epochs': 150, # 100
            ...
            for alpha in aa:
                for tau in uu:
                    for gamma in gg:
                        ...
                        params["tau"] = tau
                        params["gamma"] = gamma
                        cmd3 =generate_mia_command(params, gpu = 5,  nohup = False, mia = "../mia_example_only_target.py")
                        cmd4 = generate_mia_command(params, attack_type= "black-box", gpu = 6,  nohup = False, mia = "../mia_example_only_target.py")
