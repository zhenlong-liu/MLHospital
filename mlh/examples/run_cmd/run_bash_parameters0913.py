...
if __name__ == "__main__":
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=1) as executor1, concurrent.futures.ThreadPoolExecutor(max_workers=1) as executor2:
            ...
            for alpha in aa:
                for gamma in gg:
                    for loss in lossfunction:
                        ...
                        params["temp"] = temp
                        params["tau"] = gamma
                        cmd3 =generate_mia_command(params, gpu = 2,  nohup = False, mia = "../mia.py")
                        cmd4 = generate_mia_command(params, attack_type= "black-box", gpu = 3,  nohup = False, mia = "../mia.py")
        ...
        # python run_bash_parameters0913.py
